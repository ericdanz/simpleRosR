...
cd "/home/ed/Dropbox/GitHub/simpleRosR/src/rosserial/rosserial_xbee"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ed/Dropbox/GitHub/simpleRosR/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/ed/Dropbox/GitHub/simpleRosR/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \

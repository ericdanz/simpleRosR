...
cd "/home/ed/Dropbox/GitHub/simpleRosR/src/rosserial/rosserial_client"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ed/Dropbox/GitHub/simpleRosR/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/ed/Dropbox/GitHub/simpleRosR/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
